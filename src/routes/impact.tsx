...
import { Leaf, Heart, FlaskConical, CheckCircle2 } from "lucide-react";
import { IMPACT_REPORTS, PILLARS, PAYOUT_BATCHES } from "@/lib/mock-data";
		...
		<div className="max-w-4xl mx-auto space-y-12">
			...
			<div>
				...
				<Card>
					...
					<CardContent>
						<div className="space-y-4">
							{PAYOUT_BATCHES.filter(b => b.status === "sent").map((batch) => (
