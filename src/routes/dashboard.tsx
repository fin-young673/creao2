...
import { Info, Download, Loader2, CreditCard } from "lucide-react";
...
function DashboardPage() {
	...
	const { paymentHistory, impactMetrics } = useDataStore();
	...
	const handleDownloadReceipt = (payment: PaymentRecord) => {
		generateReceiptPDF({
			...
			innovationFund: payment.innovationFund,
			donationPool: payment.donationPool,
			planName: `£${plan.amount}/month Plan`,
